...
export default function ChatArea({
  ...
  return (
    ...
    >
      ...
      >
        {/* Hamburger — sempre visível em mobile, só quando sidebar fechada em desktop */}
        <button
      ...
      >
        ...
        {messages.length === 0 && !isSending && (
          ...
          >
            {activeConversationId ? (
              ...
              <>
                <div style={{ width: "60px", height: "60px", borderRadius: "var(--border-radius-lg)", background: "var(--bg-tertiary)", display: "flex", alignItems: "center", justifyContent: "center", opacity: 0.4 }}>
                ...
                <p style={{ fontSize: "13px", color: "var(--text-tertiary)", maxWidth: "300px", lineHeight: 1.6 }}>
        ...
        {/* Typing indicator */}
        {isSending && (
          <div className="animate-fade-in" style={{ display: "flex", alignItems: "flex-end", gap: "8px" }}>
            <div
              style={{
                padding: "14px 18px",
